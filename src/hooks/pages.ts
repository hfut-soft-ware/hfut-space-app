...
import type { Mescroll, PageParams } from '@/types'
 ...
 */
export function usePage<T>(fn: T): ToRefs<QueryDefaultData<T>>
export function usePage(fn?: (data: any) => void): ToRefs<PageParams>
export function usePage<T>(fn?: (data: any) => void | T) {
